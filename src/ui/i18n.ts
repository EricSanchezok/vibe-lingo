...
const COPY = {
  en: {
    ...
    preparingFirstReview: "Getting your first exercise ready…",
    evaluatingReviewResponse: "Taking a closer look at your expression…",
    preparingNextReview: "Getting a fresh scenario ready…",
    savingReviewProgress: "Remembering where you left off…",
    resumingReview: "Returning to where you left off…",
    preparingReviewHint: "Finding a helpful hint…",
    finishingReview: "Wrapping up this review…",
  ...
  "zh-CN": {
    ...
    journey: "学习旅程",
    loading: "正在加载学习数据…",
    preparingFirstReview: "正在为你准备第一道练习…",
    evaluatingReviewResponse: "正在仔细看看你的表达…",
    preparingNextReview: "正在换一个新场景给你练习…",
    savingReviewProgress: "正在记下这次进度…",
    resumingReview: "正在回到刚才的位置…",
    preparingReviewHint: "正在想一个恰到好处的提示…",
    finishingReview: "正在整理这次复习的结果…",
