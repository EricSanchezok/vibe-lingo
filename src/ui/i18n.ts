...
const COPY = {
  en: {
    ...
    translationHistoryHelp: "Translations you explicitly requested, kept for reuse and easy reference.",
    searchTranslations: "Search translations",
    allDirections: "All directions",
    sourceNotStored: "Source text was not stored",
  ...
  "zh-CN": {
    ...
    translationHistoryHelp: "你主动请求过的译文，可用于重复读取和快速查找。",
    searchTranslations: "搜索翻译记录",
    allDirections: "全部方向",
    sourceNotStored: "原文未保存",
    translatedText: "译文",
    direction: "语言方向",
    lastUsed: "最近使用",
    uses: "使用次数",
