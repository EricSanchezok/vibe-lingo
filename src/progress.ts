...
export function renderProgress(
  ...
  const lines = [
    ...
    "",
    `- Today: ${snapshot.summary.targetAttemptsToday} target-language attempt(s) across ${snapshot.summary.targetSessionsToday} session(s); ${snapshot.summary.findingsToday} learning finding(s) in ${snapshot.summary.findingMessagesToday} message(s)`,
